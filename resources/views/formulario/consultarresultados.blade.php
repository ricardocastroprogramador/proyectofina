                    ...
                    <div class=" navbar-header">
						...
						<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
							<ul class="menu nav navbar-nav ">
								<li class=""  ><a href='{{Route('registraduria.index')}}' >Volver</a></li>
		...
		<div class="container main">
			<div class="row grids_of_3">
				...
				<div class="col-md-4 grid1_of_3">
					<h2>Resultado Gobernación</h2>
					<img src="{{asset('plugins/assets/images/icon1.png')}}" class="img-responsive" />
					<p>En este modulo se podrán observar los resultados de la contienda electoral </p>
					<div class="rd_more1">
					<a href='{{Route('resultadogobernacion.index')}}'  class="btn_style">Ver </a>
						
					</div>
				</div>
				
				<div class="col-md-4 grid1_of_3">
					<h2>Resultado Alcaldía</h2>
					<img src="{{asset('plugins/assets/images/icon1.png')}}" class="img-responsive" />
					<p>En este modulo se podrán observar los resultados de la contienda electoral </p>
					<div class="rd_more1">
					<a href='{{Route('resultadoalcaldia.index')}}'  class="btn_style">Ver </a>
					</div>
                </div>
                
				<div class="col-md-4 grid1_of_3">
					<h2>Resultado Concejo</h2>
					<img src="{{asset('plugins/assets/images/icon1.png')}}" class="img-responsive" />
					<p>En este modulo se podrán observar los resultados de la contienda electoral </p>
					<div class="rd_more1">
					<a href='{{Route('resultadoconcejo.index')}}'  class="btn_style">Ver </a>
					</div>
                </div>
